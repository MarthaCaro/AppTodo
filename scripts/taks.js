...
window.addEventListener("load", function () {
  ...
  function renderizarTareas(listado) {
    ...
    tareasTerminadas.innerHTML = listadoTareasTerminadas
      .map((tarea) => componenteTareasTerminadas(tarea))
      .join("");
    tareasPendientes.innerHTML = listadoTareasPendientes
      .map((tarea) => componenteTareasPendientes(tarea))
      .join("");

    const numeroFinalizadas = document.querySelector("#cantidad-finalizadas");

    numeroFinalizadas.innerText = listadoTareasTerminadas.length;
    /*
...
function componenteTareasTerminadas({ description, id }) {
  return `
            <li class="tarea">
            <div class="hecha">
              <i class="fa-regular fa-circle-check"></i>
...
function componenteTareasPendientes({ createdAt, description, id }) {
